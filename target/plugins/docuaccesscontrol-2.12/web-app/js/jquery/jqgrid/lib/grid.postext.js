...
$.jgrid.extend({
	...
	setPostData : function( newdata ) {
		...
		if ( typeof(newdata) === 'object' ) {
			...
			alert("PluginMessage: cannot add a non-object postData value. postData unchanged.");
		}
	},
	appendPostData : function( newdata ) { 
		...
		if ( typeof(newdata) === 'object' ) {
			...
			alert("PluginMessage: cannot append a non-object postData value. postData unchanged.");
		}
	},
