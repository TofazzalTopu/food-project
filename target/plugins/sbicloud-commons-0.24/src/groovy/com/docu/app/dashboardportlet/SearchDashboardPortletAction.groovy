...
@Component("searchDashboardPortletAction")
class SearchDashboardPortletAction implements IAction {
  public static final Log log = LogFactory.getLog(SearchDashboardPortletAction.class)
  ...
  public Object preCondition(Object params) {
   ...
   public Object execute(def params, def object) {
    try {
       ...
       return dashboardPortletService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
