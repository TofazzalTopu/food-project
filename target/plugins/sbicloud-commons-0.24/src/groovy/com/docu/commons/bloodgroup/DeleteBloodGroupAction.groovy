...
@Component("deleteBloodGroupAction")
class DeleteBloodGroupAction implements IAction {
  public static final Log log = LogFactory.getLog(DeleteBloodGroupAction.class)
  private final String MESSAGE_HEADER = 'bloodGroup.header'
  private final String MESSAGE_SUCCESS = 'bloodGroup.delete.success'
  private final String MESSAGE_FAILURE = 'bloodGroup.failure.success'
  ...
  public Object preCondition(def params) {
    ...
    try {
        bloodGroup = bloodGroupService.read(params)
        if (!bloodGroup) {
            return UserMessageBuilder.createMessage(bloodGroupService.getUserMessage(MESSAGE_HEADER, null), Message.ERROR, bloodGroupService.getUserMessage(MESSAGE_FAILURE, null))
        }
  ...
  public Object execute(def params, def object) {
        ...
        try {
            ...
            bloodGroupService.delete(bloodGroup)
