...
@Component("updateBloodGroupAction")
class UpdateBloodGroupAction implements IAction {
  public static final Log log = LogFactory.getLog(UpdateBloodGroupAction.class)
  private final String MESSAGE_HEADER = 'bloodGroup.header'
  private final String MESSAGE_SUCCESS = 'bloodGroup.update.success'
