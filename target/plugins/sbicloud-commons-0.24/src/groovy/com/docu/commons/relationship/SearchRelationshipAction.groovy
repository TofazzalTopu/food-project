...
@Component("searchRelationshipAction")
class SearchRelationshipAction implements IAction {
    public static final Log log = LogFactory.getLog(SearchRelationshipAction.class)
    ...
    public Object execute(def params, def object) {
        try {
            ...
            return relationshipService.search(strFieldName, strFieldValue)
        } catch (Exception ex) {
