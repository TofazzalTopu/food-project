...
@Component("updateMaritalStatusAction")
class UpdateMaritalStatusAction implements IAction {
    public static final Log log = LogFactory.getLog(UpdateMaritalStatusAction.class)
