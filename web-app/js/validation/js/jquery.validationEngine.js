    ...
    var methods = {
        ...
        _validateField: function(field, options, skipAjaxFieldValidation) {
           ...
           // alert("loop i"+i);
                ...
                switch (rules[i]) {
                     //case "date":
                       // errorMsg = methods._date(field, rules, i, options);
                       // break;
                    case "required":
                    		required = true;
                    ...
                    case "docuDate":
                    //alert("i :"+i);
                        errorMsg = methods._docuDate(field, rules, i, options);
                        break;                                          
                    default:
        ...
        _docuDate: function(field, rules, i, options) {
           
            var docuDate = rules[i];
            var pattern = new RegExp(options.allrules[docuDate].regex);
           var date=field.attr('value');
          ...
          // alert("value :"+y);
            if (!pattern.test(field.attr('value')))
            {
                return options.allrules[docuDate].alertText;
             }
            else 
            {
                if(y>1900&&y<3000)
                   ...
                   if (m==1||m==3||m==5||m==7||m==8||m==10||m==12)
                    {
                      if(d < 1 || d > 31)
                      {
                      return options.allrules[docuDate].alertTextalertTextInvalidDate;
                      }
                    } 
                    else if(m==2){
                       if(y % 4 == 0 && d > 29)
                    ...
                    {
                     return options.allrules[docuDate].alertTextInvalidMonth;
                    }
                 }
                else 
                {
                 return options.allrules[docuDate].alertTextRange;
                }
            }
        },
        /**
