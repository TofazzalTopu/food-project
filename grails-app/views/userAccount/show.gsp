...
<g:form name="showapplicationuser"
    ...
    <div class="main_container">
        ...
        <div class=content_container>
            <h3>Application User Type</h3>

            <div class="element_container_big">
                <div class="block-title">
                    <div class="element-title">User Type</div>

                    <div class="clear"></div>
                </div>

                <div class="block-input">
                    <div class="element-input">${applicationUserInstance?.type_name}</div>
                    <div class="clear"></div>
                </div>
        ...
        <div class=content_container>
            <h3>Application User Enterprises</h3>

            <div class="element_container_big">
                <div class="block-title">

                    <div class="element-title">User Enterprises</div>
                ...
                <div class="block-input">
                    ...
                    <div class="element-input">${applicationUserEnterpriseInstance?.enterprise}</div>
