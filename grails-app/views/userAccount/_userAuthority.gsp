...
<script type="text/javascript">
    $(document).ready(function() {
        $("#userAuthority-list").multiselect();
    })
</script>
<g:select id="userAuthority-list" class="multiselect" multiple="multiple" name="nAuthority"
          style="width:515px; height:200px;" from="${authorityList}" optionKey="id" value="${selectedAuthorityList}">
</g:select>