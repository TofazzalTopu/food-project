...
<form name="gFormEditSalesCommission" id="gFormEditSalesCommission">
...
<div class="element_row_content_container lightColorbg pad_bot0">
    <table>
        <tr>
            ...
            <td>
                <div class='element-input inputContainer'>
                    <g:textField name="customerName" value="" class="width140 validate[required]" readonly="readonly"/>
                </div>
            </td>
            <td>
            ...
            <td>
                <div class='element-input inputContainer'>
                    <g:textField name="customerId" value="" readonly="readonly" class="width140 validate[required]"/>
                </div>
            </td>
        </tr>
    </table>
...
<div>
    <label class="txtright bold hight1x width400">
        Customer (Sales Man) for Commission
    </label>
</div>
