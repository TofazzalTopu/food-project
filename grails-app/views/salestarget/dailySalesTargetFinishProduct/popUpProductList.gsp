...
<script type="text/javascript">
    ...
    function InitProductDataTable() {
        productDataTable = $('#product_${id}').dataTable({
            ...
            "bScrollAutoCss": true,
            "iDisplayLength":10,
            "sAjaxSource":"${request.contextPath}/dailySalesTargetFinishProduct/jsonProductList?yearlySalesTargetByVolumeId=" + ${yearlySalesTargetByVolumeId} + "&targetMonth=" + ${targetMonth} + "&employeeId=" + ${employeeId},
            "aoColumns":[
