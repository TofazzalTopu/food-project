...
<title>Print Secondary Invoice</title>
...
<script type="text/javascript" language="Javascript">
    ...
    $(document).ready(function () {
        loadOrderNo();
        $("#jqgrid-grid").jqGrid({
            url: '${request.contextPath}/${params.controller}/printSecondaryInvoiceList',
            datatype: "json",
            colNames: [
                'Select',
                'Sl',
...
//     $("#jqgrid-grid").gridResize({minWidth:350,maxWidth:800,minHeight:200});
    ...
    function loadDataByOrder() {
        $("#jqgrid-grid").setGridParam({
            url: '${resource(dir:'primaryDemandOrder', file:'printSecondaryInvoiceList')}?orderNo=' + $('#searchOrderKey').val()
...
//                            loadCustomer();
                    ...
                    <tr>
                        ...
                        %{--<td>
                            <label for='customerList' class='txtright bold hight1x width100'>
                                Search Customer
                            </label>
                        </td>
                        <td>
                            <input type="text" id="customerList" name="customerList" class="width250"/>
                        </td>--}%
