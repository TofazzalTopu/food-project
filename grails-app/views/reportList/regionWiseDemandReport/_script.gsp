...
//        alert("all "+ isAll)
        ...
        window.open("${resource(dir:'reportList', file:'regionWiseDemandReport')}?format=" + format + "&productIds=" + productIds + "&packSizeIds=" + packSizeIds + "&channelIds=" + channelIds + "&categoryIds=" + categoryIds + "&fromDate=" + fromDate + "&toDate=" + toDate + "&isAll=" + isAll);
