...
<script type="text/javascript" language="Javascript">
    ...
    function generateReport() {
        ...
        window.open("${resource(dir:'reportList', file:'showSalesChannelWiseSalesSummaryReport')}?format=" + format + "&productIds=" + productIds + "&packSizeIds=" + packSizeIds + "&channelIds=" + channelIds + "&categoryIds=" + categoryIds + "&fromDate=" + fromDate + "&toDate=" + toDate + "&isAll=" + isAll);
    ...
    $(document).ready(function () {
        ...
        $("#salesChannelSummaryForm").validationEngine({   //    client side validation
            isOverflown: true,
            overflownDIV: ".ui-layout-center"
        });
        $("#salesChannelSummaryForm").validationEngine('attach');
...
//        alert("packSizeIds " + packSizeIds)
    ...
    function executePsPrecondition() {
        if (!$("#salesChannelSummaryForm").validationEngine('validate')) {
            return false;
        }
        return true;
    }
