...
<script type="text/javascript" language="Javascript">
    ...
    function generateReport() {
        ...
        window.open("${resource(dir:'reportList', file:'salesChannelWiseDemandReport')}?format=" + format + "&productIds=" + productIds + "&packSizeIds=" + packSizeIds + "&channelIds=" + channelIds + "&categoryIds=" + categoryIds + "&fromDate=" + fromDate + "&toDate=" + toDate + "&isAll=" + isAll);
