...
<title> Region Wise Sales Summary Report </title>
<style>
...
<div class="main_container">
    <div class="content_container">
        <h1> Region Wise Sales Summary Report  </h1>

        <h3> Region Wise Sales Summary Report  </h3>

        <div style="width:100%;">
            <g:render template='regionWiseDemandReport/create'
                      model="[productList: productList, productListSize: productListSize]"/>
            <br/>
            <g:render template="regionWiseSalesSummaryReport/script"
