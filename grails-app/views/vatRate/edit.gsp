                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: vatRate, field: 'rate', 'errors')}">
                                    <g:textField name="rate" value="${fieldValue(bean: vatRate, field: 'rate')}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: vatRate, field: 'supplementaryDuty', 'errors')}">
                                    <g:textField name="supplementaryDuty" value="${fieldValue(bean: vatRate, field: 'supplementaryDuty')}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: vatRate, field: 'vat', 'errors')}">
                                    <g:textField name="vat" value="${fieldValue(bean: vatRate, field: 'vat')}" />
                                </td>
                            </tr>
