...
<title>Channel Wise Sales Summary Report</title>
<style>
...
<div class="main_container">
    <div class="content_container">
        <h1>Channel Wise Sales Summary Report</h1>

        <h3>Channel Wise Sales Summary Report</h3>

        <div style="width:100%;">
            <g:render template='salesChannelWiseDemandReport/create'
                      model="[productList: productList, productListSize: productListSize]"/>
            <br/>
            <g:render template="salesChannelWiseSalesSummaryReport/script"
