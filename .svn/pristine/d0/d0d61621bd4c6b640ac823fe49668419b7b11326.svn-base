...
@Component("searchReceiveProductsFromMarketAction")
class SearchReceiveProductsFromMarketAction implements IAction {
  public static final Log log = LogFactory.getLog(SearchReceiveProductsFromMarketAction.class)
  ...
  public Object preCondition(Object params) {
   ...
   public Object execute(def params, def object) {
    try {
       ...
       return receiveProductsFromMarketService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
