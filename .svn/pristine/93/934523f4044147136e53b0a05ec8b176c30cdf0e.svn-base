<%@ page import="com.bits.bdfp.inventory.product.externalproduct.ExternalProductStock" %>
<form name='gFormExternalProductStock' id='gFormExternalProductStock'>
        ...
        <g:if test="${list}">
            <g:if test="${list.size() == 1}">
                <div class='element-input inputContainer'>
                    <g:textField name="enterPriseName" class="validate[required]" readonly="readonly"
                                 value="${list[0].name}"/>
    ...
    <div class="element_row_content_container lightColorbg pad_bot0">
        ...
        <div class='element-input inputContainer'>
            <div class='element-input inputContainer'>
                <g:select name="externalProduct.id" id="externalProduct"
                          class="validate[required]"
                          optionKey="id" from="${externalProductList}"
                          value=""
    ...
    <div class="element_row_content_container lightColorbg pad_bot0">
        ...
        <div class='element-input inputContainer'>
            <g:textField name="inQuantity" class="validate[required]" value="${externalProductStock?.inQuantity}"/>
        </div>
    </div>
