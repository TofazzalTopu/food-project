...
@Component("updateAddressTypeAction")
class UpdateAddressTypeAction implements IAction {
    public static final Log log = LogFactory.getLog(UpdateAddressTypeAction.class)
    private final String MESSAGE_HEADER = 'Address Type'
    private final String MESSAGE_SUCCESS = 'Address Type Updated Successfully'
