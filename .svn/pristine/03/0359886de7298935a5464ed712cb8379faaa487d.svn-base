 ...
 */
@Component("fetchDepositToDepositPoolDataAction")
class FetchDepositToDepositPoolDataAction extends Action{
    @Autowired
    ...
    public Object execute(Object params, Object Object) {
        try {
            List list = cashReceivedFromBranchService.fetchData(params)
            return list
        } catch (Exception ex) {
