...
@Component("createCurrencyDemonstrationAction")
class CreateCurrencyDemonstrationAction implements IAction {
  ...
  private final String MESSAGE_SUCCESS = 'currencyDemonstration.save.success'
  ...
  public Object preCondition(def params) {
    ...
    try {
        currencyDemonstration = new CurrencyDemonstration()
        currencyDemonstration.properties = params
        currencyDemonstration.dateCreated = new Date()
  ...
  public Object execute(def params, def object) {
        ...
        try {
            ...
            currencyDemonstrationService.save(currencyDemonstration)
        } catch (Exception ex) {
            log.error(ex.message)
            return UserMessageBuilder.createMessage(currencyDemonstrationService.getUserMessage(MESSAGE_HEADER, null), Message.ERROR, currencyDemonstration, ex)
        }
