 ...
 */
@Component("listTargetBasedIncentiveCurrentSlabAction")
class ListTargetBasedIncentiveCurrentSlabAction extends Action {
    ...
    public Object execute(Object params, Object user) {
        return incentiveSetupService.getTargetBasedIncentiveCurrentSlabList(params)
    }
