...
@Component("readDistributionPointTerritorySubAreaAction")
class ReadDistributionPointTerritorySubAreaAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object params, Object object) {
    try {
       return distributionPointTerritorySubAreaService.read(Long.parseLong(params.id))
     } catch (Exception ex) {
