 ...
 */
@Component("listSubordinateForDailyTargetAction")
class ListSubordinateForDailyTargetAction extends Action {
    ...
    public Object execute(def params, def object) {
        try{
            return dailySalesTargetFinishProductService.listSubordinateForDailyTarget(params)
        } catch (Exception ex) {
