 ...
 */
@Component("listRegionByApplicationUserAction")
class ListRegionByApplicationUserAction extends Action {
    ...
    public Object execute(Object params, Object object) {
        try {
            return territorySubAreaService.listRegionByApplicationUser()
        } catch (Exception ex) {
