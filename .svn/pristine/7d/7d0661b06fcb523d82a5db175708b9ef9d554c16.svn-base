...
<head>
    ...
    <title><g:layoutTitle default="BDFE Banking"/></title>
...
%{--color theme end--}%
    ...
    %{--<link rel="stylesheet" href="${resource(dir: 'js/jquery/pqselect', file: 'pqselect.min.css')}" type="text/css"/>--}%
    ...
    <g:javascript src="highcharts-min.js"/>
    <g:javascript src="highcharts-more.js"/>
    ...
    %{--<link rel="stylesheet" href="${resource(dir: 'js/jquery/jquerymultiselect/css', file: 'jquery.multiselect.css')}" type="text/css"/>--}%
    %{--<g:javascript src="jquery/jquerymultiselect/js/jquery.multiselect.min.js"/>--}%
    <!--[if lt IE 7]>
    <script>
    ...
    %{--<g:javascript src="jquery/pqselect/pqselect.min.js"/>--}%
    <g:javascript src="common.js"/>
    <g:layoutHead/>
    <script type="text/javascript">
            ...
            $.ajaxSetup({
                error: function (xhr, status, err) {
                    ...
                    if (xhr.status == 0) {
                        ...
                        errorMessage = "Session Out. Please login";
...
<div class="ui-layout-west  layout-node">
    ...
    %{--<g:include controller="menu" action="mostVisitedLeftMenu" params="[controllerName: params.controller, actionName: params.action]"/>--}%
