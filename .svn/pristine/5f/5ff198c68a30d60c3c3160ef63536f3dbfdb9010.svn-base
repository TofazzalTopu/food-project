 ...
 */
@Component("listRetailOrderDetailsForConsolidateAction")
class ListRetailOrderDetailsForConsolidateAction extends Action {
    ...
    public Object execute(def params, def object) {
        try {
            List result = retailOrderService.listRetailsOrderDetailsForConsolidate(params)
