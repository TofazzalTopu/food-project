 ...
 */
@Component("listReceivableOrderAction")
class ListReceivableOrderAction extends Action {
    ...
    public Object execute(Object params, Object object) {
        try{
            ...
            objectList = registerFinishGoodService.listReceivableOrder(params)
    ...
    private List wrapListInGridEntityList(objList, start) {
        ...
        objList.each { instance ->
            ...
            obj.cell = ["${counter}",
                    ...
                    "${instance.orderDate? instance.invoiceAmount : ''}"
            ]
            instants << obj
            counter++
        };
