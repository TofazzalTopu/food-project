...
@Component("searchDocumentTypeAction")
class SearchDocumentTypeAction implements IAction {
    public static final Log log = LogFactory.getLog(SearchDocumentTypeAction.class)
    ...
    public Object execute(def params, def object) {
        try {
            ...
            return documentTypeService.search(strFieldName, strFieldValue)
        } catch (Exception ex) {
