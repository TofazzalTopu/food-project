...
/**
 * Created by prianka.adhikary on 10/13/2015.
 */
@Component("listCheckBonusEligibilityAction")
class ListCheckBonusEligibilityAction extends Action{
    ...
    public Object execute(Object params, Object object) {
        try{
            ...
            result = customerBonusFinishGoodService.getListForCheckEligibility(this,params,applicationUser)
