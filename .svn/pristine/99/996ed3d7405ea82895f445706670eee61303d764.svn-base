...
@Component("listBankPaymentMethodAction")
class ListBankPaymentMethodAction extends Action {
  ...
  BankPaymentMethodService bankPaymentMethodService
   ...
   public Object execute(Object params, Object object) {
    ...
    result = bankPaymentMethodService.getListForGrid(this)
...
//                  "${instance.enterpriseConfiguration? instance.enterpriseConfiguration : ''}",
                  ...
                  "${instance.shortName? instance.shortName : ''}",
