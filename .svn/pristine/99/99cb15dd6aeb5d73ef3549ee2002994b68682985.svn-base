...
@Component("listSubWarehouseAction")
class ListSubWarehouseAction extends Action {
  ...
  SubWarehouseService subWarehouseService
   ...
   public Object execute(Object params, Object object) {
    ...
    result = subWarehouseService.getListForGrid(this)
  ...
  private List wrapListInGridEntityList(objList, start) {
    ...
    objList.each { instance ->
      ...
      obj.cell = ["${counter}",
                  ...
                  "${instance.subWarehouseType? instance.subWarehouseType : ''}",
