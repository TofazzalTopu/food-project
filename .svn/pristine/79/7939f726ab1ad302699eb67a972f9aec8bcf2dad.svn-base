...
@Component("listDeliveryTruckAction")
class ListDeliveryTruckAction extends Action {
  ...
  DeliveryTruckService deliveryTruckService
   ...
   public Object execute(Object params, Object object) {
    ...
    result = deliveryTruckService.getListForGrid(this)
  ...
  private List wrapListInGridEntityList(objList, start) {
    ...
    objList.each { instance ->
      ...
      obj.cell = ["${counter}",
                  ...
                  "${instance.loadingCapacity? instance.loadingCapacity : ''}",
