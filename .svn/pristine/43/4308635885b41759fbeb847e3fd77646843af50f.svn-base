...
@Component("listWorkflowUserMappingAction")
class ListWorkflowUserMappingAction extends Action {
  ...
  WorkflowUserMappingService workflowUserMappingService
   ...
   public Object execute(Object params, Object object) {
    ...
    result = workflowUserMappingService.getListForGrid(this)
  ...
  private List wrapListInGridEntityList(objList, start) {
    ...
    objList.each { instance ->
      ...
      obj.cell = ["${counter}",
                  ...
                  "${instance.applicationUser.username? instance.applicationUser.username : ''}",
