 ...
 */
@Component("listQuantityBasedIncentiveCurrentSlabAction")
class ListQuantityBasedIncentiveCurrentSlabAction extends Action {
    ...
    public Object execute(Object params, Object user) {
        return incentiveSetupService.getQuantityBasedIncentiveCurrentSlabList(params)
    }
