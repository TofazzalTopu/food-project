 ...
 */
@Component("listCustomerByGeoAndCategoryAction")
class ListCustomerByGeoAndCategoryAction extends Action{
    ...
    public Object execute(Object params, Object object) {
        try{
            ...
            objectList = onePercentBonusService.listCustomer(params)
