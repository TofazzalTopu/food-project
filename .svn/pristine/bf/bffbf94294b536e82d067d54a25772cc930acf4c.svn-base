 ...
 */
@Component("listAllProductByMasterAndMainProductAction")
class ListAllProductByMasterAndMainProductAction extends Action {
    ...
    public Object execute(Object params, Object user) {
        return incentiveSetupService.getAllProductListByMasterAndMainProduct(params)
    }
