 ...
 */
@Component("itemAvailabilityDetailsForProcessOrderAction")
class ItemAvailabilityDetailsForProcessOrderAction extends Action{
    ...
    public Object execute(Object params, Object object) {
        try{
            ...
            result = processOrderService.itemAvailabilityDetailsForProcessOrder(params)
