...
@Component("searchCustomerTerritorySubAreaAction")
class SearchCustomerTerritorySubAreaAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return customerTerritorySubAreaService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
