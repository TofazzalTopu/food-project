...
@Component("searchCustomerMasterAction")
class SearchCustomerMasterAction extends Action {
...
CustomerMasterService customerMasterService
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return customerMasterService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
  ...
  private String convertToSearchable(String source){
    ...
    protected Object executeCustomerByCategory(Object params, Object object2) {
        try {
            List list

            list = customerMasterService.searchCustomerByCategory(params.id)
