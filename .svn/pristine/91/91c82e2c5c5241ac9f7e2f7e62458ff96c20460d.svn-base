 ...
 */
@Component("secondaryItemAvailabilityForProcessOrderAction")
class SecondaryItemAvailabilityForProcessOrderAction extends Action{
    ...
    public Object execute(Object params, Object object) {
        try{
            ...
            result = processOrderService.itemAvailabilitySecondaryOrderProcess(this, params)
    ...
    private List wrapListInGridEntityList(objList, start) {
        ...
        objList.each { instance ->
            ...
            obj.cell = [
                        ...
                        "${instance.process_qty? instance.process_qty : 0}",
                        "${instance.available_qty? instance.available_qty : 0}"
            ]
            instants << obj
            counter++
        };
