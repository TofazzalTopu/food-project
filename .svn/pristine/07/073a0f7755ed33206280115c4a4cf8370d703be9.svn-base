 ...
 */
@Component("listIncentiveProgramByTypeAction")
class ListIncentiveProgramByTypeAction extends Action {
    ...
    public Object execute(Object params, Object user) {
        return incentiveSetupService.getIncentiveProgramListByType(params)
    }
