...
@Component("listWorkflowAction")
class ListWorkflowAction extends Action {
    ...
    public Object execute(Object params, Object object) {
        try {
            ...
            result = workflowService.getListForGrid(this, params)
    ...
    private List wrapListInGridEntityList(objList, start) {
        ...
        objList.each { instance ->
            ...
            obj.cell = ["${counter}",
                        ...
                        "${instance.menuName ? instance.menuName : ''}"
            ]
            instants << obj
            counter++
        };
