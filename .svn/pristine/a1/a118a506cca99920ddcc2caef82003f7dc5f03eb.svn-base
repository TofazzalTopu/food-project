 ...
 */
@Component("listVbPrimaryUomByProductAction")
class ListVbPrimaryUomByProductAction extends Action {
    ...
    public Object execute(Object params, Object user) {
        return incentiveSetupService.getVbPrimaryUomByProduct(params)
    }
