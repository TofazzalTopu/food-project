...
@Component("searchDistributionPointTerritorySubAreaAction")
class SearchDistributionPointTerritorySubAreaAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return distributionPointTerritorySubAreaService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
