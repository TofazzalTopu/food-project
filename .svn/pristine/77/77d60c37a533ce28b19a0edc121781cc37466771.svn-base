 ...
 */
@Component("listSalesAmountBasedIncentiveCurrentSlabAction")
class ListSalesAmountBasedIncentiveCurrentSlabAction extends Action {
    ...
    public Object execute(Object params, Object user) {
        return incentiveSetupService.getSalesAmountBasedIncentiveCurrentSlabList(params)
    }
