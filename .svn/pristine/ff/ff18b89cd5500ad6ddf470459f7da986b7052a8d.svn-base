...
@Component("searchSecondaryDemandOrderDetailsAction")
class SearchSecondaryDemandOrderDetailsAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return secondaryDemandOrderDetailsService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
