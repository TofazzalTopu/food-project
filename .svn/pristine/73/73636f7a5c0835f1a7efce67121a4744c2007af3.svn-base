...
//                });
    ...
    function distributeMonthWiseTarget(){
        ...
        jqGridMonthlyAssignedTargetList = $("#jqgrid-grid-subordinate-monthly").jqGrid({
            ...
            colModel:[
                {name:'id', index:'id', width:0, hidden:true},
                {name:'code', index:'code', width:70, align:'left'},
                {name:'name', index:'name', width:150, align:'left'},
                {name:'jan', index:'jan', width:80, align:'right', sorttype:'number', formatter:"number", editable: true, editrules:{number:true}, formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 2}},
                {name:'feb', index:'feb', width:80, align:'right', sorttype:'number', formatter:"number", editable: true, editrules:{number:true}, formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 2}},
                {name:'mar', index:'mar', width:80, align:'right', sorttype:'number', formatter:"number", editable: true, editrules:{number:true}, formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 2}},
                {name:'apr', index:'apr', width:80, align:'right', sorttype:'number', formatter:"number", editable: true, editrules:{number:true}, formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 2}},
                {name:'may', index:'may', width:80, align:'right', sorttype:'number', formatter:"number", editable: true, editrules:{number:true}, formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 2}},
                {name:'jun', index:'jun', width:80, align:'right', sorttype:'number', formatter:"number", editable: true, editrules:{number:true}, formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 2}},
                {name:'jul', index:'jul', width:80, align:'right', sorttype:'number', formatter:"number", editable: true, editrules:{number:true}, formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 2}},
                {name:'aug', index:'aug', width:80, align:'right', sorttype:'number', formatter:"number", editable: true, editrules:{number:true}, formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 2}},
                {name:'sep', index:'sep', width:80, align:'right', sorttype:'number', formatter:"number", editable: true, editrules:{number:true}, formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 2}},
                {name:'oct', index:'oct', width:80, align:'right', sorttype:'number', formatter:"number", editable: true, editrules:{number:true}, formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 2}},
                {name:'nov', index:'nov', width:80, align:'right', sorttype:'number', formatter:"number", editable: true, editrules:{number:true}, formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 2}},
                {name:'dec', index:'dec', width:80, align:'right', sorttype:'number', formatter:"number", editable: true, editrules:{number:true}, formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 2}},
        ...
        $("#create-button-monthlySalesTargetByAmount").show();
...
//        console.log(selectedEmployeeCount);
    ...
    function updateDayWiseTarget(employeeId, monthName, updatedValue){
        var updatedMonthValue = 0.00;
        var lastDayValue = 0.00
        var m = 1;
        switch (monthName){
            case "jan":
                ...
                lastDayValue = updatedValue - (updatedMonthValue.toFixed(2) * 30);
                $("#jan_" + employeeId + "_31").val(lastDayValue.toFixed(2));
            ...
            case "feb":
                ...
                lastDayValue = updatedValue - (updatedMonthValue.toFixed(2) * (daysInFeb - 1));
                $("#feb_" + employeeId + "_" + daysInFeb).val(lastDayValue.toFixed(2));
            ...
            case "mar":
                ...
                lastDayValue = updatedValue - (updatedMonthValue.toFixed(2) * 30);
                $("#mar_" + employeeId + "_31").val(lastDayValue.toFixed(2));
            ...
            case "apr":
                ...
                lastDayValue = updatedValue - (updatedMonthValue.toFixed(2) * 29);
                $("#apr_" + employeeId + "_30").val(lastDayValue.toFixed(2));
            ...
            case "may":
                ...
                lastDayValue = updatedValue - (updatedMonthValue.toFixed(2) * 30);
                $("#may_" + employeeId + "_31").val(lastDayValue.toFixed(2));
            ...
            case "jun":
                ...
                lastDayValue = updatedValue - (updatedMonthValue.toFixed(2) * 29);
                $("#jun_" + employeeId + "_30").val(lastDayValue.toFixed(2));
            ...
            case "jul":
                ...
                lastDayValue = updatedValue - (updatedMonthValue.toFixed(2) * 30);
                $("#jul_" + employeeId + "_31").val(lastDayValue.toFixed(2));
            ...
            case "aug":
                ...
                lastDayValue = updatedValue - (updatedMonthValue.toFixed(2) * 30);
                $("#aug_" + employeeId + "_31").val(lastDayValue.toFixed(2));
            ...
            case "sep":
                ...
                lastDayValue = updatedValue - (updatedMonthValue.toFixed(2) * 29);
                $("#sep_" + employeeId + "_30").val(lastDayValue.toFixed(2));
            ...
            case "oct":
                ...
                lastDayValue = updatedValue - (updatedMonthValue.toFixed(2) * 30);
                $("#oct_" + employeeId + "_31").val(lastDayValue.toFixed(2));
            ...
            case "nov":
                ...
                lastDayValue = updatedValue - (updatedMonthValue.toFixed(2) * 29);
                $("#nov_" + employeeId + "_30").val(lastDayValue.toFixed(2));
            ...
            case "dec":
                ...
                lastDayValue = updatedValue - (updatedMonthValue.toFixed(2) * 30);
                $("#dec_" + employeeId + "_31").val(lastDayValue.toFixed(2));
...
//        }
    ...
    function executeAjaxMonthlySalesTargetByAmount() {
        if (!executePreConditionMonthlySalesTargetByAmount()) {
            return false;
        }
        var data = [];
        ...
        var selfMonthWiseTarget = 0.00;
        var selfYearlyTarget  = 0.00;
        var selfAnnualTarget = Number($("#yearlyTarget").val());
        data.push({'name':'yearlyTarget', 'value': selfAnnualTarget});
        for(var j = 1; j <= 12; j++){
            selfMonthWiseTarget = Number($("#month_" + j).val());
            selfYearlyTarget =  selfYearlyTarget + Number(selfMonthWiseTarget.toFixed(2));
            var keyIndex = j-1;
        ...
        if(selfYearlyTarget.toFixed(2) != selfAnnualTarget.toFixed(2)){
            MessageRenderer.renderErrorText("Your Total Target=" + selfYearlyTarget.toFixed(2) + " which is not equal to " + selfAnnualTarget.toFixed(2));
            return
        }
        ...
        for (var i=0; i < length; i++) {
            ...
            for(k = 1; k <= 31; k++){
                ...
                data.push({'name':'subordinates_' + i + '_month_0_'+ k + '_targetAmount', 'value': $("#jan_" + gd[i].id + "_" + k).val()});
            }
            ...
            for(k = 1; k <= 29; k++){
                ...
                data.push({'name':'subordinates_' + i + '_month_1_'+ k + '_targetAmount', 'value': $("#feb_" + gd[i].id + "_" + k).val()});
            }
            ...
            for(k = 1; k <= 31; k++){
                ...
                data.push({'name':'subordinates_' + i + '_month_2_'+ k + '_targetAmount', 'value': $("#mar_" + gd[i].id + "_" + k).val()});
            }
            ...
            for(k = 1; k <= 30; k++){
                ...
                data.push({'name':'subordinates_' + i + '_month_3_'+ k + '_targetAmount', 'value': $("#apr_" + gd[i].id + "_" + k).val()});
            }
            ...
            for(k = 1; k <= 31; k++){
                ...
                data.push({'name':'subordinates_' + i + '_month_4_'+ k + '_targetAmount', 'value': $("#may_" + gd[i].id + "_" + k).val()});
            }
            ...
            for(k = 1; k <= 30; k++){
                ...
                data.push({'name':'subordinates_' + i + '_month_5_'+ k + '_targetAmount', 'value': $("#jun_" + gd[i].id + "_" + k).val()});
            }
            ...
            for(k = 1; k <= 31; k++){
                ...
                data.push({'name':'subordinates_' + i + '_month_6_'+ k + '_targetAmount', 'value': $("#jul_" + gd[i].id + "_" + k).val()});
            }
            ...
            for(k = 1; k <= 31; k++){
                ...
                data.push({'name':'subordinates_' + i + '_month_7_'+ k + '_targetAmount', 'value': $("#aug_" + gd[i].id + "_" + k).val()});
            }
            ...
            for(k = 1; k <= 30; k++){
                ...
                data.push({'name':'subordinates_' + i + '_month_8_'+ k + '_targetAmount', 'value': $("#sep_" + gd[i].id + "_" + k).val()});
            }
            ...
            for(k = 1; k <= 31; k++){
                ...
                data.push({'name':'subordinates_' + i + '_month_9_'+ k + '_targetAmount', 'value': $("#oct_" + gd[i].id + "_" + k).val()});
            }
            ...
            for(k = 1; k <= 30; k++){
                ...
                data.push({'name':'subordinates_' + i + '_month_10_'+ k + '_targetAmount', 'value': $("#nov_" + gd[i].id + "_" + k).val()});
            }
            ...
            for(k = 1; k <= 31; k++){
                ...
                data.push({'name':'subordinates_' + i + '_month_11_'+ k + '_targetAmount', 'value': $("#dec_" + gd[i].id + "_" + k).val()});
            }
...
<div>
    ...
    <table class="simple-table-css" style="width: 800px;">
        ...
        <tr>
            <g:each in="${monthWiseYearlyTargetList}" var="monthWiseYearlyTarget">
                <td class="width80">
                    <g:if test="${monthWiseYearlyTarget.id}">
                        ...
                        <script type="text/javascript">
                            $("#reset-button-monthlySalesTargetByAmount").hide();
                        </script>
                    </g:if>
                    <g:else>
                        <g:textField class="width80 alin_right amount"
                                     ...
                                     maxlength="9"/>
                        <script type="text/javascript">
                            $("#reset-button-monthlySalesTargetByAmount").show();
                        </script>
                    </g:else>
