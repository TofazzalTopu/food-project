        ...
        <div class="main_container" style="overflow: hidden;">
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="customer_${customerId}">
                ...
                <tr class="element_row_content_container inputContainer lightColorbg pad_bot0">
                    ...
                    <td>
                        <div class='element-input inputContainer'>
                            <g:textField class="amount alin_right width100" name="orderAmount" id="orderAmount"
                    ...
                    <td>
                        <div class='element-input inputContainer'>
                            <g:textField class="amount alin_right width100" name="receivableAmount"
                                         id="receivableAmount"
                ...
                <tr class="element_row_content_container inputContainer lightColorbg pad_bot0">
                    ...
                    <td>
                        <div class='element-input inputContainer'>
                            <g:textField class="amount alin_right width100" name="securityAmount" id="securityAmount"
                                         value="${params.customerSecurityDeposit}"
                                         readonly="readonly" disabled="disabled"/>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class='element-input inputContainer'>
                            <g:textField class="width100" name="priority" id="priority" value="${params.priority}"
                                         readonly="readonly"
                                         disabled="disabled"/>
                        </div>
                    </td>
                ...
                <tr class="element_row_content_container inputContainer lightColorbg pad_bot0">
                    ...
                    <td>
                        <div class='element-input inputContainer'>
                            <g:textField class="amount alin_right width100" name="limit" id="limit"
                                         value="${params.limit}" readonly="readonly"
                                         disabled="disabled"/>
                        </div>
                    </td>
                </tr>
