...
@Component("readCustomerTerritorySubAreaAction")
class ReadCustomerTerritorySubAreaAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object params, Object object) {
    try {
       return customerTerritorySubAreaService.read(Long.parseLong(params.id))
     } catch (Exception ex) {
