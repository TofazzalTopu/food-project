...
/**
 * Created by mdalinaser.khan on 2/28/16.
 */
@Component("listIssuedFinishGoodAction")
class ListIssuedFinishGoodAction  extends Action{
    ...
    public Object execute(Object params, Object object) {
        try{
            ...
            result = finishGoodWarehouseService.getListIssuedItems(this, params, applicationUser)
    ...
    private List wrapListInGridEntityList(objList, start) {
        ...
        objList.each { instance ->
            ...
            obj.cell = [
                    ...
                    "${instance.out_quantity? instance.out_quantity : '0'}",
                    "${instance.uom? instance.uom : ''}",
                    "${instance.batch_no? instance.batch_no : ''}",
                    "${instance.unit_price? instance.unit_price : '0'}",
                    "${instance.reference_no? instance.reference_no : ''}",
                    "${instance.sub_inventory? instance.sub_inventory : ''}",
