 ...
 */
@Component("getFactorySalableProductListAction")
class GetFactorySalableProductListAction extends Action {
    ...
    public Object execute(Object params, Object user) {
        return promotionSetupService.getFactorySalableProductList(params)
    }
