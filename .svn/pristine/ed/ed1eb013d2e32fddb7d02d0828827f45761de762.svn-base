...
<title><g:message code="journalReport.create.label" default="Product Received Register Report"/></title>
<style>
...
<div class="main_container">
    <div class="content_container">
        <h1><g:message code="ledgerReport.create.label" default="Product Received Register Report"/></h1>
...
<script>
    ...
    function executeAjax() {
        ...
        window.open("${resource(dir:'productReceivedRegisterReport', file:'printReport')}?format=PDF&ledgerDateFrom="+ledgerDateFrom+"&ledgerDateTo="+ledgerDateTo+"&dpPoint="+distributionPoint);
