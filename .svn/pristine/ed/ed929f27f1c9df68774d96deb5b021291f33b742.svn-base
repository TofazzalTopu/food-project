...
@Component("searchCustomerPriorityAction")
class SearchCustomerPriorityAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return customerPriorityService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
