            ...
            for (int i = 0; i < primaryOrderIdList.length; i++) {
                ...
                if (primaryDemandOrder) {
                    ...
                    if (isDemandMeet) {
                        ...
                        primaryInvoice.code = CodeGenerationUtil.instance.generateCode(primaryDemandOrder.customerOrderFor.enterpriseConfiguration, "PRIMARY_INVOICE", "", "", "", "", "", currentMonth, currentYear, "", "")
...
//                          Accounting Treatment Of Bonus Promotion
                            ...
                            journalDetails.debitAmount = 0.00
                            journalDetails.particular = " Accounts Receivable for [" + factoryDp.code + "] " + factoryDp.name
                            journalDetailsListForBonus.add(journalDetails)
                        }
