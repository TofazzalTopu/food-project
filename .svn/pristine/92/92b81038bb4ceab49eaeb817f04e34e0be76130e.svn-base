...
@Component("searchSubWarehouseTypeAction")
class SearchSubWarehouseTypeAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return subWarehouseTypeService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
