...
@Component("searchSecondaryDemandOrderAction")
class SearchSecondaryDemandOrderAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return secondaryDemandOrderService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
