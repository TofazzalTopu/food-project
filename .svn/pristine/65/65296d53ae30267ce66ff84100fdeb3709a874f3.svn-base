 ...
 */
@Component("listDistributionPointForWriteOffAction")
class ListDistributionPointForWriteOffAction extends Action {
    @Autowired
    ...
    public Object execute(Object params, Object Object) {
        try {
            List objectList = writeOffService.fetchDp(params)
            return objectList
        } catch (Exception ex) {
