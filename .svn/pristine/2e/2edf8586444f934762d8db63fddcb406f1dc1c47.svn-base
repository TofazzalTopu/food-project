 ...
 */
@Component("listSalesAmountBasedCurrentCustomerAction")
class ListSalesAmountBasedCurrentCustomerAction extends Action {
    ...
    public Object execute(Object params, Object user) {
        return incentiveSetupService.getSalesAmountBasedCurrentCustomersList(params)
    }
