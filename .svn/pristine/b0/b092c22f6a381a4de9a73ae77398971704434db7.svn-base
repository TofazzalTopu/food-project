...
<title><g:message code="targerVsAchievement.create.label" default="Targer Vs Achievement"/></title>
...
//        var territoryName=$('#territory').selected();
        ...
        window.open("${resource(dir:'statementFormat', file:'rpttargetVsachievementValue')}?format=PDF&fromDate="+fromDate+"&toDate="+toDate);
...
<div class="main_container">
    <div class="content_container">
        <h1><g:message code="targerVsAchievement.create.label" default="Targer Vs Achievement In Value"/></h1>

        <h3><g:message code="targerVsAchievement.Info.label" default="Targer Vs Achievement In Value"/></h3>
