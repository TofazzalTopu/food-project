...
<div class="element-content-form-elements">
	<label style="padding-right: 5px;" for='religionName' class='bold txtalgnrght'><g:message code='religion.religionName.label' default='Religion Name' /></label>
	<g:textField name="religionName" id="religionName" class="w-p25" value="${religion?.religionName}" />
	</div>
<div class="element-content-form-elements">
	<label style="padding-right: 5px;" for='description' class='bold txtalgnrght dblhght'><g:message code='religion.description.label' default='Description' /></label>
