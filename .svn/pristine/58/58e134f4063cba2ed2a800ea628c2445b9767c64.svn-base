...
<title><g:message code="division.create.label" default="Business Month"/></title>

<div class="main_container">

    <div class="content_container">
        <h1><g:message code="division.create.label" default=" Business Month"/></h1>
        <h3><g:message code="division.Info.label" default="Business Month Open"/></h3>
        <g:if test="${financialYearList.size()>0}">
            <g:render template='/financialYear/businessMonth/create'/>
            <div class="clear height5"></div>
            <g:render template="/financialYear/businessMonth/script"/>
