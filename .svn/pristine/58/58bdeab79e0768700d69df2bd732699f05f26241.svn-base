 ...
 */
@Component("listAllSearchIncentiveProgramByCriteriaAction")
class ListAllSearchIncentiveProgramByCriteriaAction extends Action {
    ...
    public Object execute(Object params, Object user) {
        try {
            return incentiveSetupService.getAllSearchIncentiveProgramListByCriteria(params)
        }catch(Exception ex){
