...
<title><g:message code="division.create.label" default="Division"/></title>
<div class="main_container">
    <div class="content_container">
        <h1><g:message code="division.create.label" default="Division"/></h1>
        <h3><g:message code="division.Info.label" default="Division Information"/></h3>
