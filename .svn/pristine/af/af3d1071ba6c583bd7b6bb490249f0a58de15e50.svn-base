...
<title>Opening Stock Upload</title>

<div class="main_container">
    <div class="content_container">
        <h1>Opening Stock Upload</h1>
        <h3>Opening Stock Upload Info</h3>

        <div style="width:100%;">
           <form name="openingStockUploadForm" id="openingStockUploadForm" action="${request.contextPath}/${params.controller}/upload" method="post" enctype="multipart/form-data">
