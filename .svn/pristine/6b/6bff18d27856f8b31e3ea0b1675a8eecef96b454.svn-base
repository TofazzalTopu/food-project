...
@Component("searchProductPricingTypeAction")
class SearchProductPricingTypeAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return productPricingTypeService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
