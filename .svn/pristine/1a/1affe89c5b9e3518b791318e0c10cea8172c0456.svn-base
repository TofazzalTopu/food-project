...
@Component("searchMarketReturnAction")
class SearchMarketReturnAction implements IAction {
  public static final Log log = LogFactory.getLog(SearchMarketReturnAction.class)
  ...
  public Object preCondition(Object params) {
   ...
   public Object execute(def params, def object) {
    try {
       ...
       return marketReturnService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
