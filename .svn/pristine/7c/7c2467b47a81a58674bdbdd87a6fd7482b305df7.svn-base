...
<form name='gFormGender' id='gFormGender'>
	...
	<label for='genderType' class='bold txtalgnrght'><g:message code='gender.genderType.label' default='Gender Type' /></label>
	<g:textField name="genderType" id="genderType" class="w-p25" value="${gender?.genderType}" />
	</div>
<div class="element-content-form-elements">
	<label for='description' class='bold txtalgnrght hight2x'><g:message code='gender.description.label' default='Description' /></label>
