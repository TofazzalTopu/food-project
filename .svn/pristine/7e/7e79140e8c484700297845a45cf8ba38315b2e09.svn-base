 ...
 * @author Burt
 */
public class BitsPostgreSQLDialect extends PostgreSQLDialect {
    ...
    public static class TableNameSequenceGenerator
        ...
        /**
         * {@inheritDoc}
         * If the parameters do not contain a {@link org.hibernate.id.SequenceGenerator#SEQUENCE} name, we
