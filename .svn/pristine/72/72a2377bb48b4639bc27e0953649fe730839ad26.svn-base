 ...
 */
@Component("listQuantityBasedCurrentCustomerAction")
class ListQuantityBasedCurrentCustomerAction extends Action {
    ...
    public Object execute(Object params, Object user) {
        return incentiveSetupService.getQuantityBasedCurrentCustomersList(params)
    }
