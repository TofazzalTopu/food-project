...
@Component("searchReligionAction")
class SearchReligionAction implements IAction {
    public static final Log log = LogFactory.getLog(SearchReligionAction.class)
    ...
    public Object execute(def params, def object) {
        try {
            ...
            return religionService.search(strFieldName, strFieldValue)
        } catch (Exception ex) {
