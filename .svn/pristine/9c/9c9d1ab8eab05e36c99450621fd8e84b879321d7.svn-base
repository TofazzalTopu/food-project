...
@Component("searchProcessMarketReturnAction")
class SearchProcessMarketReturnAction implements IAction {
  public static final Log log = LogFactory.getLog(SearchProcessMarketReturnAction.class)
  ...
  public Object preCondition(Object params) {
   ...
   public Object execute(def params, def object) {
    try {
       ...
       return processMarketReturnService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
