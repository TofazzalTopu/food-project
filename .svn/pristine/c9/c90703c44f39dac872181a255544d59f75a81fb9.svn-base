 ...
 */
@Component("listTargetBasedCurrentCustomerAction")
class ListTargetBasedCurrentCustomerAction extends Action {
    ...
    public Object execute(Object params, Object user) {
        return incentiveSetupService.getTargetBasedCurrentCustomersList(params)
    }
