 ...
 */
@Component("listGeoAndCustomersListByTerritoryAction")
class ListGeoAndCustomersListByTerritoryAction extends Action {
    ...
    public Object execute(Object params, Object user) {
        return incentiveSetupService.getGeoAndCustomersListByTerritory(params)
    }
