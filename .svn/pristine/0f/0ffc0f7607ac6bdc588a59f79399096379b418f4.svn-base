 ...
 */
@Component("onHandQtyItemListAction")
class OnHandQtyItemListAction extends Action{
    ...
    public Object execute(Object params, Object object) {
        try{
            ...
            result = finishGoodWarehouseService.getListOnHandQtyItem(this,params,applicationUser)
