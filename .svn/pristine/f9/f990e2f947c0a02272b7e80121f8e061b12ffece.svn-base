...
@Component("updateDashboardPortletAction")
class UpdateDashboardPortletAction implements IAction {
  public static final Log log = LogFactory.getLog(UpdateDashboardPortletAction.class)
