...
<title>Sales Report Institutional</title>
...
//        alert("hello");
        ...
        window.open("${resource(dir:'salesReportMT', file:'rptSalesReportINS')}?format=PDF&fromDate=" + fromDate + "&toDate=" + toDate + "&territoryId=" + territoryId + "&territoryName=" + territoryName);
