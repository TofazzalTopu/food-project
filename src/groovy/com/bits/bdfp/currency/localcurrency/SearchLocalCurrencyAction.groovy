...
@Component("searchLocalCurrencyAction")
class SearchLocalCurrencyAction implements IAction {
  public static final Log log = LogFactory.getLog(SearchLocalCurrencyAction.class)
  ...
  public Object preCondition(Object params) {
   ...
   public Object execute(def params, def object) {
    try {
       ...
       return localCurrencyService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
