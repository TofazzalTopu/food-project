...
@Component("createLocalCurrencyAction")
class CreateLocalCurrencyAction implements IAction {
  ...
  private final String MESSAGE_SUCCESS = 'localCurrency.save.success'
  ...
  public Object preCondition(def params) {
    ...
    try {
        ...
        localCurrency.dateCreated = new Date()
  ...
  public Object execute(def params, def object) {
        ...
        try {
            ...
            localCurrencyService.save(localCurrency)
        } catch (Exception ex) {
            log.error(ex.message)
            return UserMessageBuilder.createMessage(localCurrencyService.getUserMessage(MESSAGE_HEADER, null), Message.ERROR, localCurrency, ex)
        }
