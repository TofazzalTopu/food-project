...
@Component("searchCurrencyDemonstrationAction")
class SearchCurrencyDemonstrationAction implements IAction {
  public static final Log log = LogFactory.getLog(SearchCurrencyDemonstrationAction.class)
  ...
  public Object preCondition(Object params) {
   ...
   public Object execute(def params, def object) {
    try {
       ...
       return currencyDemonstrationService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
