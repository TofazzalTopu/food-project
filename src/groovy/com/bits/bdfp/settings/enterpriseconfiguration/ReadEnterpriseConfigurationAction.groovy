...
@Component("readEnterpriseConfigurationAction")
class ReadEnterpriseConfigurationAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object params, Object object) {
    try {
       return enterpriseConfigurationService.read(Long.parseLong(params.id))
     } catch (Exception ex) {
