...
@Component("searchCodeGenerationFormatAction")
class SearchCodeGenerationFormatAction implements IAction {
  public static final Log log = LogFactory.getLog(SearchCodeGenerationFormatAction.class)
  ...
  public Object preCondition(Object params) {
   ...
   public Object execute(def params, def object) {
    try {
       ...
       return codeGenerationFormatService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
