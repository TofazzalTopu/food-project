...
@Component("listDepositPoolAction")
class ListDepositPoolAction extends Action {
  ...
  DepositPoolService depositPoolService
   ...
   public Object execute(Object params, Object object) {
    ...
    result = depositPoolService.getListForGrid(this)
  ...
  private List wrapListInGridEntityList(objList, start) {
    ...
    objList.each { instance ->
      ...
      obj.cell = ["${counter}",
                  ...
                  "${instance.accountNo? instance.accountNo : ''}",
