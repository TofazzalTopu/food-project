...
@Component("updateMonthlySalesTargetByVolumeAction")
class UpdateMonthlySalesTargetByVolumeAction extends Action {
    public static final Log log = LogFactory.getLog(UpdateMonthlySalesTargetByVolumeAction.class)
    private final String MESSAGE_HEADER = 'Update Monthly Sales Target By Volume'
    private final String MESSAGE_SUCCESS = 'Monthly Sales Target By Volume Updated Successfully'
    Message message
        ...
        try {
            ...
            for(int i = 0; i < employeeCount; i++){
                ...
                if(!subordinateYearlySalesTargetByVolume){
                    return this.getMessage(MESSAGE_HEADER, Message.ERROR, "[" + subordinateEmployee.code + "]" + subordinateEmployee.name + ":Yearly Sales Target is not available")
                }
                if(subordinateYearlySalesTargetByVolume){
            ...
            monthlySalesTargetByVolumeService.updateSalesTarget(mapInstance, currentEmployee)
