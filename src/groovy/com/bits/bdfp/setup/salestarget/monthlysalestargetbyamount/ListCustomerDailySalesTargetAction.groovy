 ...
 */
@Component("listCustomerDailySalesTargetAction")
class ListCustomerDailySalesTargetAction extends Action {
    ...
    public Object execute(def params, def object) {
        try{
            return monthlySalesTargetByAmountService.listCustomerYearlyDailySalesTarget(params)
        } catch (Exception ex) {
