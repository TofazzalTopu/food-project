 ...
 */
@Component("yearlySalesTargetByEmployeeAction")
class YearlySalesTargetByEmployeeAction extends Action {
    ...
    public Object execute(def params, def object) {
        try{
            ...
            return monthlySalesTargetByAmountService.yearlySalesTarget(Integer.parseInt(params.targetYear), customerMaster)
        } catch (Exception ex) {
