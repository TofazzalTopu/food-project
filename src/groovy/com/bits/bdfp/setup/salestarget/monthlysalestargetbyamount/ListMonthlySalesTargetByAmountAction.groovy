...
@Component("listMonthlySalesTargetByAmountAction")
class ListMonthlySalesTargetByAmountAction extends Action {
    ...
    public Object execute(def params, def object) {
        try{
            ...
            result = monthlySalesTargetByAmountService.getListForGrid(this, params)
            ...
            objList.each { instance ->
                ...
                obj.cell = ["${counter}",
                          "${instance.id ? instance.id : ''}",
                            ...
                            "${instance.targetMonth? instance.targetMonth : ''}",
