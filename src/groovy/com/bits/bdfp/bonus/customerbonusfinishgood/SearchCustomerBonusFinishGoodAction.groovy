...
@Component("searchCustomerBonusFinishGoodAction")
class SearchCustomerBonusFinishGoodAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return customerBonusFinishGoodService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
