...
@Component("searchBonusCriteriaSetupAction")
class SearchBonusCriteriaSetupAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return bonusCriteriaSetupService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
