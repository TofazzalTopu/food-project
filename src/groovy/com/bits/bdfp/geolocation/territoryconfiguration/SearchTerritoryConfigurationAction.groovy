...
@Component("searchTerritoryConfigurationAction")
class SearchTerritoryConfigurationAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return territoryConfigurationService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
   ...
   public Object postCondition(Object params, Object object) {
    ...
    public Object fetchTerritoryByUserId(Object params, Object object) {
        try {
            //ApplicationUser applicationUser=(ApplicationUser) object
            return territoryConfigurationService.fetchTerritoryByUserId()
        } catch (Exception ex) {
            log.error(ex.message)
            return null
        }
