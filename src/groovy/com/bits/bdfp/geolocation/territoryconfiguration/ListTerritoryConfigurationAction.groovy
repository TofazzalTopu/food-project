...
@Component("listTerritoryConfigurationAction")
class ListTerritoryConfigurationAction extends Action {
  ...
  TerritoryConfigurationService territoryConfigurationService
   ...
   public Object execute(Object params, Object object) {
    ...
    result = territoryConfigurationService.getListForGrid(this)
...
//                  "${instance.unionInfo? instance.unionInfo : ''}",
