...
@Component("searchCustomerPaymentTypeAction")
class SearchCustomerPaymentTypeAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return customerPaymentTypeService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
