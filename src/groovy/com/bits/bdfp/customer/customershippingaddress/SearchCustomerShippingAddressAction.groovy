...
@Component("searchCustomerShippingAddressAction")
class SearchCustomerShippingAddressAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return customerShippingAddressService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
