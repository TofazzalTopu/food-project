...
@Component("searchCustomerCategoryAction")
class SearchCustomerCategoryAction extends Action {
...
CustomerCategoryService customerCategoryService
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return customerCategoryService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
  ...
  private String convertToSearchable(String source){
    ...
    protected Object executeCustomerCategory(Object params, Object object2) {
        try {
            List list

            list = customerCategoryService.searchCustomerCategory()
