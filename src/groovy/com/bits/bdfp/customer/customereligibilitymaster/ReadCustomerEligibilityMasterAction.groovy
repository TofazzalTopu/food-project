...
@Component("readCustomerEligibilityMasterAction")
class ReadCustomerEligibilityMasterAction extends Action {
    public static final Log log = LogFactory.getLog(ReadCustomerEligibilityMasterAction.class)
    ...
    public Object execute(def params, def object) {
        ...
        Map objectData = ObjectUtil.getPersistenceData(customerEligibilityMaster)
        return objectData
    }
