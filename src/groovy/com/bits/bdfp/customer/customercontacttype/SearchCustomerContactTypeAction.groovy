...
@Component("searchCustomerContactTypeAction")
class SearchCustomerContactTypeAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return customerContactTypeService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
