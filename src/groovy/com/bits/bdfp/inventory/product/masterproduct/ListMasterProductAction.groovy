...
@Component("listMasterProductAction")
class ListMasterProductAction extends Action {
    ...
    public Object execute(Object params, Object object) {
        try {
            ...
            result = masterProductService.getListForGrid(this)
    ...
    private List wrapListInGridEntityList(objList, start) {
        ...
        objList.each { instance ->
            ...
            obj.cell = ["${counter}",
                        ...
                        "${instance.sequenceNumber ? instance.sequenceNumber : ''}",
