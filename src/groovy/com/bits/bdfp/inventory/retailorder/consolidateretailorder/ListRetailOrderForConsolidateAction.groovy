 ...
 */
@Component("listRetailOrderForConsolidateAction")
class ListRetailOrderForConsolidateAction extends Action {
    ...
    public Object execute(def params, def object) {
        try {
            List result = retailOrderService.listRetailOrderForConsolidate(params)
