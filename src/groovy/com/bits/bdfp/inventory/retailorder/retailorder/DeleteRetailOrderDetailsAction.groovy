 ...
 */
@Component("deleteRetailOrderDetailsAction")
class DeleteRetailOrderDetailsAction extends Action {
    ...
    public Object execute(def params, def object) {
        boolean success = retailOrderService.deleteRetailOrderDetails(params)
        if(success){
