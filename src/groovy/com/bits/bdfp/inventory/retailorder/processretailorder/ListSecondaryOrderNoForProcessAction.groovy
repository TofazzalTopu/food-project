 ...
 */
@Component("listSecondaryOrderNoForProcessAction")
class ListSecondaryOrderNoForProcessAction extends Action {
    ...
    public Object execute(Object params, Object object) {
        try {
            return retailOrderService.secondaryOrderNoAutoCompleteForProcessing(params)
        }
        catch (Exception ex) {
