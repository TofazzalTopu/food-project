...
@Component("searchAdjustUsingHoAction")
class SearchAdjustUsingHoAction extends Action {
    public static final Log log = LogFactory.getLog(SearchAdjustUsingHoAction.class)
    ...
    public Object execute(def params, def object) {
        try {
            ...
            return adjustUsingHoService.search(strFieldName, strFieldValue)
        }catch (Exception ex) {
