...
@Component("searchWriteOffAction")
class SearchWriteOffAction extends Action {
    public static final Log log = LogFactory.getLog(SearchWriteOffAction.class)
    ...
    public Object execute(def params, def object) {
        try {
            ...
            return writeOffService.search(strFieldName, strFieldValue)
        }catch (Exception ex) {
