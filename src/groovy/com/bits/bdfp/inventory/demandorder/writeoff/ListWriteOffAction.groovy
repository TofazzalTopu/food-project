...
@Component("listWriteOffAction")
class ListWriteOffAction extends Action {
    ...
    public Object execute(def params, def object) {
        try{
            ...
            result = writeOffService.getListForGrid(this, params)
            ...
            objList.each { instance ->
                ...
                obj.cell = ["${counter}",
                          "${instance.id ? instance.id : ''}",
                            ...
                            "${instance.writeOffAmount? instance.writeOffAmount : ''}"
                            ]
                instants << obj
                counter++
            }
