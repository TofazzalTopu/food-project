...
@Component("searchDemandOrderApprovalWorkflowAction")
class SearchDemandOrderApprovalWorkflowAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return demandOrderApprovalWorkflowService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
