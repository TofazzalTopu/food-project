...
@Component("listDemandOrderApprovalWorkflowAction")
class ListDemandOrderApprovalWorkflowAction extends Action {
  ...
  DemandOrderApprovalWorkflowService demandOrderApprovalWorkflowService
   ...
   public Object execute(Object params, Object object) {
    ...
    result = demandOrderApprovalWorkflowService.getListForGrid(this)
  ...
  private List wrapListInGridEntityList(objList, start) {
    ...
    objList.each { instance ->
      ...
      obj.cell = ["${counter}",
                  ...
                  "${instance.isApprove? instance.isApprove : ''}",
                  "${instance.isReject? instance.isReject : ''}",
                  "${instance.userApprovedReject? instance.userApprovedReject : ''}",
                  "${instance.dateApprovedReject? instance.dateApprovedReject : ''}",
