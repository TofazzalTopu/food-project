 ...
 */
@Component("processOrderAutoCompleteAction")
class ProcessOrderAutoCompleteAction extends Action {
    ...
    public Object execute(Object params, Object object) {
        try {
            ...
            return primaryDemandOrderService.listOrderNoForProcess(orderNO)
