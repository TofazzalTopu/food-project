...
/**
 * Created by prianka.adhikary on 10/4/2015.
 */
@Component("printInvoiceNoAutoCompleteAction")
class InvoiceNoAutoCompleteAction extends Action{
    ...
    public Object execute(Object params, Object object) {
        try {
            ...
            return primaryDemandOrderService.listInvoiceNo(orderNO,applicationUser)
