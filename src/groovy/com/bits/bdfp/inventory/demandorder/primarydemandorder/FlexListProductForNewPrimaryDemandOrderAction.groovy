 ...
 */
@Component("flexListProductForNewPrimaryDemandOrderAction")
class FlexListProductForNewPrimaryDemandOrderAction extends Action {
    ...
    public Object execute(Object params, Object object) {
        try {
            return primaryDemandOrderService.listFinishProductForPrimaryDemandOrder(params)
        } catch (Exception ex) {
