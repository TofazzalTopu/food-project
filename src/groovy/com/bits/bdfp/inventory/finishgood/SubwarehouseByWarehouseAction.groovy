...
@Component("subwarehouseByWarehouseAction")
class SubwarehouseByWarehouseAction extends Action {
  ...
  FinishGoodWarehouseService finishGoodWarehouseService
   ...
   public Object execute(Object params, Object object) {
       try {
           return finishGoodWarehouseService.selectSubwarehouseByWarehouse(params)
       } catch (Exception ex) {
