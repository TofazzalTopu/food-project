 ...
 */
@Component("listCustomersCommissionAmountAction")
class ListCustomersCommissionAmountAction extends Action {
    ...
    public Object execute(Object params, Object object) {
        try {
            List result = salesCommissionService.listCustomersCommissionByDP(params)
            return result;
        }
        catch (Exception ex) {
