 ...
 */
@Component("listVolumeBasedIncentiveCurrentSlabAction")
class ListVolumeBasedIncentiveCurrentSlabAction extends Action {
    ...
    public Object execute(Object params, Object user) {
        return incentiveSetupService.getVolumeBasedIncentiveCurrentSlabList(params)
    }
