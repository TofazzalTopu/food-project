 ...
 */
@Component("listVolumeBasedCurrentCustomerAction")
class ListVolumeBasedCurrentCustomerAction extends Action {
    ...
    public Object execute(Object params, Object user) {
        return incentiveSetupService.getVolumeBasedCurrentCustomersList(params)
    }
