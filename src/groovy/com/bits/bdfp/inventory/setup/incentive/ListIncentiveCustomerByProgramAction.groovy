 ...
 */
@Component("listIncentiveCustomerByProgramAction")
class ListIncentiveCustomerByProgramAction extends Action {
    ...
    public Object execute(Object params, Object user) {
        try{
            return incentiveSetupService.getIncentiveCustomersByProgram(params)
        }catch(Exception ex){
