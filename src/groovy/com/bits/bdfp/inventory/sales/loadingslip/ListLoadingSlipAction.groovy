...
@Component("listLoadingSlipAction")
class ListLoadingSlipAction extends Action {
  ...
  LoadingSlipService loadingSlipService
   ...
   public Object execute(Object params, Object object) {
    ...
    result = loadingSlipService.getListForGrid(this)
  ...
  private List wrapListInGridEntityList(objList, start) {
    ...
    objList.each { instance ->
      ...
      obj.cell = ["${counter}",
                  ...
                  "${instance.dateSlipDate? instance.dateSlipDate : ''}",
                  "${instance.printCount? instance.printCount : ''}",
