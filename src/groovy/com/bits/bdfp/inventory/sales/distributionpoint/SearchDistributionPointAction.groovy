...
@Component("searchDistributionPointAction")
class SearchDistributionPointAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return distributionPointService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
