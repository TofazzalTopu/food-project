...
@Component("searchDistributionPointWarehouseAction")
class SearchDistributionPointWarehouseAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return distributionPointWarehouseService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
