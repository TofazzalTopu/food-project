...
@Component("searchWorkflowUserMappingAction")
class SearchWorkflowUserMappingAction extends Action {
  ...
  public Object preCondition(Object params, Object object) {
   ...
   public Object execute(Object fieldName, Object fieldValue) {
    try {
       ...
       return workflowUserMappingService.search(strFieldName, strFieldValue)
     } catch (Exception ex) {
